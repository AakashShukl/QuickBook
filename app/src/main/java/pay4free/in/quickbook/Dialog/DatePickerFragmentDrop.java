package pay4free.in.quickbook.Dialog;
...
public class DatePickerFragmentDrop extends DialogFragment implements TimePicker.OnTimeChangedListener, DatePicker.OnDateChangedListener {
    ...
    public void onTimeChanged(TimePicker view, int hourOfDay, int minute) {
        ...
        DateTime.drop=day+"/"+(month1+1)+"/"+yearr+" "+hourOfDay+":"+minute;
        TextView tv = (TextView) getActivity().findViewById(R.id.editdrop);
